              ...
              {!isAuthenticated ? (
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 sm:space-x-3 bg-white hover:bg-neutral border border-neutral-dark px-3 sm:px-4 py-2 sm:py-2.5 rounded-full transition-all duration-300 hover:shadow-md"
                  >
                    <img
                      src={user.avatar}
                      alt={user.name}
                  ...
                  {/* User Menu Dropdown */}
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-56 sm:w-64 bg-white rounded-2xl shadow-xl border border-neutral-dark py-2 z-50 animate-mobile-safe">
                      ...
                      <div className="py-2">
                        <Link
                          ...
                          className="flex items-center px-4 py-3 text-gray-700 hover:bg-neutral transition-colors"
                        >
              ...
              {!isAuthenticated && (
                <div className="pt-3 border-t border-neutral">
                  <Link 
                    to="/signin" 
                    onClick={closeMobileMenu}
                    className="block w-full bg-sunset-gradient text-white py-3 px-4 rounded-xl font-semibold text-center transition-all duration-300 hover:scale-105 shadow-lg animate-coral-glow"
                  >
                    Sign In / Sign Up
                  </Link>
                </div>
