...
export const Home: React.FC = () => {
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-secondary via-midnight to-midnight-dark min-h-screen flex items-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-white text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                <Link 
                  to="/event-discovery"
                  className="inline-flex items-center justify-center bg-sunset-gradient hover:shadow-coral-glow text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105 shadow-2xl animate-coral-glow"
                >
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="grid grid-cols-2 gap-3 sm:gap-4 animate-float">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 transform -rotate-2 hover:rotate-0 transition-transform duration-500 border border-mango/20">
                  <Music className="w-6 h-6 sm:w-8 sm:h-8 text-mango mb-2 sm:mb-3" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-secondary mb-4 sm:mb-6">
              Why Choose <span className="bg-sunset-gradient bg-clip-text text-transparent">Our Platform</span>?
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-coral-gradient rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:animate-coral-glow">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-mango-gradient rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:animate-mango-glow">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-midnight-gradient rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-hover">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-success to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
      ...
      {/* Stats Section */}
      <section className="py-16 sm:py-20 bg-midnight-gradient relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-accent/5"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center text-white">
            <div className="group">
              <div className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 bg-sunset-gradient bg-clip-text text-transparent group-hover:animate-pulse">50K+</div>
              <div className="text-white/90 text-sm sm:text-lg">Events Hosted</div>
            </div>
            <div className="group">
              <div className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 bg-sunset-gradient bg-clip-text text-transparent group-hover:animate-pulse">10K+</div>
              <div className="text-white/90 text-sm sm:text-lg">Trusted Vendors</div>
            </div>
            <div className="group">
              <div className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 bg-sunset-gradient bg-clip-text text-transparent group-hover:animate-pulse">500K+</div>
              <div className="text-white/90 text-sm sm:text-lg">Tickets Sold</div>
            </div>
            <div className="group">
              <div className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 bg-sunset-gradient bg-clip-text text-transparent group-hover:animate-pulse">4.9</div>
              <div className="text-white/90 text-sm sm:text-lg flex items-center justify-center">
                <Star className="w-4 h-4 sm:w-5 sm:h-5 fill-current mr-1 text-accent" />
                Average Rating
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link 
              to="/event-discovery"
              className="inline-flex items-center justify-center bg-sunset-gradient hover:shadow-coral-glow text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg animate-coral-glow"
            >
