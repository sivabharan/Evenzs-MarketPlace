...
import { Calendar, Users, Mail, Lock, Eye, EyeOff, Sparkles, Loader2, Ticket, CheckCircle } from 'lucide-react';
...
export const SignIn: React.FC = () => {
  ...
  const handleFacebookSignIn = async () => {
    ...
    try {
      await signInWithFacebook(activeTab);
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-xl">
            <h4 className="text-sm font-medium text-gray-900 mb-2">Benefits of Social Sign-in:</h4>
